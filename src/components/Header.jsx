// Header component
export default function Header({ websiteLogo, websiteName }) {
  // JSX Output
  return (
    <header className="">
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="md:flex items-start md:gap-12">
          ...
          <div className="hidden md:block">
            <nav aria-label="Global">
              <ul className="flex items-center gap-6 text-sm">
                <li>
                  <a
                    className="text-slate-100 hover:text-slate-200/75 transition"
                    href="#aboutMe"
                  >
                    About me
                  </a>
                ...
                <li>
                  <a
                    className="text-slate-100 transition hover:text-slate-200/75"
                    href="#competenciesMd"
                  >
                    Competencies
                  </a>
